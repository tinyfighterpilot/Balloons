var elements = ['topBefore', 'BB', 'popabble','p', 'greeting','r1', 'l1', 'r2', 'l2','gridItem','container','intro', 'logo', 'menu', 'bar', 'lilpop', 'popup', 'navbutton', 'fa-facebook', 'fa-instagram', 'fa-paypal', 'gridImg', 'logo2', 'slide', 'right', 'left'];
